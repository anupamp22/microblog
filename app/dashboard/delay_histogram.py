...
# # Read in data
# flights = pd.read_csv('/home/anupam/eclipse-workspace/microblog-0.15/app/data/complete_flights.csv', index_col=0)[['arr_delay', 'carrier', 'name']]

# # Available carrier list
# available_carriers = list(flights['name'].astype(str).unique())
